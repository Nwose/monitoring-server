...
const Fastestfinger = () => {
  ...
  const retrieveMalpractice = () => {
    MonitoringDataService.getAllFastest()
      .then((response) => {
  ...
  const refreshList = () => {
   ...
   const columns = useMemo(
    () => [
      ...
      {
        Header: "TimeSpentInSeconds",
        accessor: "timeSpentInSeconds",
              },
                {
        Header: "Status",
        accessor: "status",
  ...
  return (
    <>
      <Showcase title={'Fast Fingers'}
       route={'Fast Fingers / Fast-Fingers center(s)'} />
      <div className='bg-white border h-[26rem] w-full'>
        <p className='border-b-2 p-2 text-gray-400 font-semibold'>Fast-Fingers center(s) || 02/26/2023 / Session 1</p>
                  ...
                  {headerGroups.map(headerGroup => (
                    <tr {...headerGroup.getHeaderGroupProps()}>
                      {headerGroup.headers.map(column => (
                        ...
                        <th
                          scope="col"
                          className="group px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"
